...
async def analyze_image(file: UploadFile = File(...)):
    ...
    try:
        ...
        prompt = """
        คุณคือ AI scan หน้า บอกว่า คนนี้ % ความหล่อหรือความสวย วัดด้วยความสมบูรณ์แบบของใบหน้าอยู่ที่กี่ %
        โปรดวิเคราะห์ภาพนี้แล้วตอบในรูปแบบต่อไปนี้อย่างเคร่งครัด (ห้ามเปลี่ยนรูปแบบ):

        DECISION: [ระบุเปอร์เซ็นต์ความหล่อหรือความสวย (0-100%) / ไม่พบบุคคลในภาพ]
        CONFIDENCE: [ตัวเลข 0-100 บ่งบอกระดับความมั่นใจของ AI ในการจับจุดและวิเคราะห์สัดส่วนใบหน้า]
        BIAS_ANALYSIS: [อธิบายปัจจัยที่อาจทำให้ AI เกิดความสับสนหรือประเมินสัดส่วนใบหน้าคลาดเคลื่อน เช่น การแต่งหน้า, การใช้แอปพลิเคชันแต่งรูป (ฟิลเตอร์), มุมกล้องที่ทำให้หน้าดูเปลี่ยนไป, แสงและเงาที่ตกกระทบใบหน้า, หรือทรงผมที่ปิดบังโครงหน้า ฯลฯ ตอบเป็นภาษาไทย 2-4 ประโยค]
        """
